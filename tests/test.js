...
const bitversewallet = window.bitversewallet;
...
describe('BitverseWeb3Provider constructor tests', () => {
  test('test constructor.name', () => {
    const provider = new bitversewallet.Provider({});
    const web3 = new bitversewallet.Web3(provider);
    expect(web3.currentProvider.constructor.name).toBe('BitverseWeb3Provider');
  });
  ...
  test('test setConfig', (done) => {
    const provider = new bitversewallet.Provider(ropsten);
  ...
  test('test eth_chainId', (done) => {
    const provider = new bitversewallet.Provider(bsc);
    const web3 = new Web3(provider);
  ...
  test('test eth_accounts', (done) => {
    const provider = new bitversewallet.Provider(mainnet);
    const web3 = new Web3(provider);
  ...
  test('test eth_sign', (done) => {
    ...
    bitversewallet.postMessage = (message) => {
